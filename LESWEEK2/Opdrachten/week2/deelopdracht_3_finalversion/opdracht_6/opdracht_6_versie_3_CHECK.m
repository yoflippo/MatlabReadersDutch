...
checkingVar.testFunctionInput.data = {{round(randn(1,10)*10)} {round(randn(1,10)*10)} {round(randn(1,10)*10)}};
checkingVar.testFunctionInput.DOUBLE_OUTPUT = true;
% FILL literalsP, FOR INSTANCE WITH OPERATIONS THAT SHOULD BE PRESENT IN
% The number to the right of the string designates the number of times the
% string should be present.
checkingVar.literalsP = {'mean(balSnelheid)' 1 'median(balSnelheid)' 1 '(balSnelheid)' 3};
