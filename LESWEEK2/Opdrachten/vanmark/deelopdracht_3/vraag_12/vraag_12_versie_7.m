%% Vraag 12
%
% Stelling 1:   De if-statement wordt gebruikt voor het maken van beslissingen.
%
% Stelling 2:   De if-statement wordt uitgevoerd als de expressie tot een
%				true wordt geevalueerd.                                  
%
