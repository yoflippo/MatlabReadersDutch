% Opdracht 8
% Het onderstaande programma is een bestaand programma, maar er staan *één* programmeerfouten in.
% Jij moet deze programmeerfout gaan zoeken

% LET OP: Je mag maar  *vier* karakters verwijderen bijvoorbeeld:
% 2 haakjes en 2 cijfers
%         of
% 4 letters
%        of
% 3 letters en 1 getal.
% etc.


% Je mag de namen van variabelen wel aanpassen. 
% Je hebt het goed gedaan wanneer de variabele waardeXpYp een rijvector is van 1 bij 140
% je krijgt dan een pop-up met goed gedaan! 
...
[waardeRow, waardeColumn] = size(waardeXpYp);
