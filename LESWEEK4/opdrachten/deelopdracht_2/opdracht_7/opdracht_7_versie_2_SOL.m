...
% heeft. Wanneer je het programma laat runnen en je krijgt de melding
...
% rechtsom geroteerd staan maar nog allemaal om de oorsprong draaien
 ...
 % xp en yp element per element vermenigvuldigen
for i = 1:length(xp)
    XpYp(i) = xp(i) .* yp(i);  %%!! hier staat een 1 ipv i bij de x.
end
