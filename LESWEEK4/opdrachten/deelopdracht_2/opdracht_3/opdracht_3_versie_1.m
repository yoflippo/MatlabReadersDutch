...
leeftijd = [ 12 32 12 39 18 37 27 19 30 19 20);
gemiddeldeLeeftijd = gemiddelde(leeftijd);

% de leeftijd van de derde proefpersoon oproepen:

leeftijdDerdeproefpersoon= leeftijd(3,1);
